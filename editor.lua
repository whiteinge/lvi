...
function M.new_ed()
  return {
    ...
    -- Autoindent bookkeeping. Esc trims a line left holding only its autoindent,
    -- so the editor has to know which leading blanks it inserted itself; a
    -- blanks-only regex would take blanks the user typed with them.
