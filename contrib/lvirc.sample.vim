...
map \l[ :bg lvi-list first<CR>                " jump to the FIRST entry (vim :cfirst)...
map \l] :bg lvi-list last<CR>                 "   ...or the last (:clast); no list wraps, so
"                                               these are the wrap, done by hand
